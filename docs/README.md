...
You can run OpenAI models by setting the `REMOVED` environment variable to your OpenAI API key and setting openai as the model provider in your character file.
